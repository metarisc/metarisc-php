...
class ObjetAnalyseDeRisque extends ModelAbstract
{
    private ?\Metarisc\Model\ObjetAnalyseDeRisqueAnalyseRisque $analyse_risque = null;
    ...
    public static function unserialize(array $data) : self
    {
        ...
        /** @var \Metarisc\Model\ObjetDocumentTechnique[] $data['documents_techniques'] */
    ...
    public function getAnalyseRisque() : ?ObjetAnalyseDeRisqueAnalyseRisque
    {
    ...
    {
        $this->analyse_risque=ObjetAnalyseDeRisqueAnalyseRisque::unserialize($analyse_risque);
    }
