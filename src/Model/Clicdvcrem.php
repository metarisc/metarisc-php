...
/*
 * Objet représentant les caractéristiques liées à l'activité, l'implantation, la construction, les dégagements, la ventilation et désenfumage, l'électricité, éclairage, chauffage et climatisation, les risques particuliers, les moyens de secours d'un ERP.
*/

class Clicdvcrem extends ModelAbstract
{
    ...
    private ?int $effectif_public_total                                                        = null;
    private ?int $effectif_personnel                                                           = null;
    private ?int $effectif_personnel_total                                                     = null;
    ...
    public static function unserialize(array $data) : self
    {
        ...
        /** @var \Metarisc\Model\EffectifsNiveau[] $data['tableau_des_effectifs'] */
        ...
        /** @var int $data['effectif_public_total'] */
        $object->setEffectifPublicTotal($data['effectif_public_total']);

        /** @var int $data['effectif_personnel'] */
        $object->setEffectifPersonnel($data['effectif_personnel']);

        /** @var int $data['effectif_personnel_total'] */
        $object->setEffectifPersonnelTotal($data['effectif_personnel_total']);
        ...
        /** @var \Metarisc\Model\Local[] $data['locaux'] */
        ...
        /** @var \Metarisc\Model\Degagement[] $data['degagement_normaux'] */
        $object->setDegagementNormaux($data['degagement_normaux']);

        /** @var \Metarisc\Model\Degagement[] $data['degagements_accessoires'] */
        ...
        /** @var \Metarisc\Model\Degagement[] $data['degagement_supplementaires'] */
    ...
    public function getEffectifPublicTotal() : ?int
    {
        return $this->effectif_public_total;
    }

    public function setEffectifPublicTotal(int $effectif_public_total = null) : void
    {
        $this->effectif_public_total=$effectif_public_total;
    }
    ...
    public function getEffectifPersonnelTotal() : ?int
    {
        return $this->effectif_personnel_total;
    }

    public function setEffectifPersonnelTotal(int $effectif_personnel_total = null) : void
    {
        $this->effectif_personnel_total=$effectif_personnel_total;
    }
