...
class ObjetRGlesDECI extends ModelAbstract
{
    private ?array&lt;string,float&gt; $pibi_conformite_matrice_seuil_pesee_1bar_par_nature = null; 
...
private ?float $pena_conformite_seuil_volume_citerne = null; 
    ...
    public static function unserialize(array $data): ObjetRGlesDECI
    {
        $object = new ObjetRGlesDECI();



        
        /** @var array&lt;string,float&gt; $data['pibi_conformite_matrice_seuil_pesee_1bar_par_nature'] */
        ...
        return $object;
            ...
            public function getPibiConformiteMatriceSeuilPesee1barParNature(): ?array&lt;string,float&gt;
            {
    ...
    public function setPibiConformiteMatriceSeuilPesee1barParNature(array&lt;string,float&gt; $pibi_conformite_matrice_seuil_pesee_1bar_par_nature = null):void
    {
