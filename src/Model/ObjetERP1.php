...
class ObjetERP1 extends ModelAbstract
{
    private ?\Metarisc\Model\ObjetERPImplantation $implantation                     = null;
    private ?\Metarisc\Model\ObjetERP1DescriptifTechnique $descriptif_technique     = null;
    ...
    private ?\Metarisc\Model\ObjetERP1EtablissementRattache $etablissement_rattache = null;
    ...
    public function getDescriptifTechnique() : ?ObjetERP1DescriptifTechnique
    {
    ...
    {
        $this->descriptif_technique=ObjetERP1DescriptifTechnique::unserialize($descriptif_technique);
    }
    ...
    public function getEtablissementRattache() : ?ObjetERP1EtablissementRattache
    {
    ...
    {
        $this->etablissement_rattache=ObjetERP1EtablissementRattache::unserialize($etablissement_rattache);
    }
